    ...
    <div class="popup-wrapper">
      <div class="popup-content">
        ...
        <form>
          ...
          <div class="tright">
            <button class="movebtn movebtnedit" type="button" @click="showEditProfile">
              <i class="fa-solid fa-pen-to-square"></i> Editar
            </button>

            <!-- ✅ Logout SOLO cuando presionas el botón -->
            <button class="movebtn movebtnlogout" type="button" @click="logout">
...
export default {
  ...
  methods: {
    ...
    getEditableFields() {
      ...
      // fallback por si entra otro rol
      return { name: this.user.name };
    },
    ...
    // ✅ IMPORTANTE: aquí NO se limpia localStorage.
    // Emitimos el evento para que NavBar haga el logout centralizado.
    logout() {
      this.$emit('logout');
    }
  }
